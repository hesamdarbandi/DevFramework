...
using DevFramework.Core.Infrastructure.Constants;
...
namespace DevFramework.Core.Infrastructure.Auth
{
    public class JwtFactory : IJwtFactory
    {
        ...
        protected ClaimsIdentity _clIdentity;
        ...
        public virtual async Task<string> GenerateEncodedToken(string userName, ClaimsIdentity identity)
        {
            _claims = new[]
            {
                 ...
                 identity.FindFirst(Constant.JwtClaimIdentifiers.Rol),
        ...
        {
            _clIdentity = new ClaimsIdentity(new GenericIdentity(userName, "Token"), new[]
            {
                new Claim(Constant.JwtClaimIdentifiers.Id, id),
                new Claim(Constant.JwtClaimIdentifiers.Rol, Constant.JwtClaims.ApiAccess)
            });
            return _clIdentity;
        }
